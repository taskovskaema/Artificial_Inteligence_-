...
if __name__ == '__main__':
    ...
    proverka=classifier.predict([test])[0]  #poshto ne go transformirame morame [] lista da go naprajme kaj dvete
    proverka2=classifier.predict_proba([test])
